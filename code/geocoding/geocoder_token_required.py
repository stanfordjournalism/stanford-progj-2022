...
class ArcGIS:
    ...
    @classmethod
    def geocode(cls, url, token, addresses, results=[], batch_size=1000, throttle=1):
        payload = {
            'token': token,
            'f': 'json',
...
if __name__ == '__main__':
    token = os.environ['STANFORD_ARCGIS_API_KEY']
    try:
